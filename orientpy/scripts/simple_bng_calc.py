...
def main(args=None):
    if args is None:
        # Run Input Parser
        args = get_args.get_bng_calc_arguments()
    # Load Database
        ...
        for i, ev in enumerate(cat):
            ...
            if accept:
                ...
                if args.verb > 1:
                    ...
                    print("*   Origin Time: " + bngdata.meta.time.strftime("%Y-%m-%d %H:%M:%S"))
                    print("*   Lat: {0:6.2f};        Lon: {1:7.2f}".format(bngdata.meta.lat, bngdata.meta.lon))
                    print("*   Dep: {0:6.2f} km;     Mag: {1:3.1f}".format(bngdata.meta.dep, bngdata.meta.mag))
